...
export default {
        ...
        return {
            ...
            warnings: [
                ...
                },
                {
                    name: 'cookie',
                    text:
                        '<p><strong>Our site uses cookies</strong></p><p>We use cookies to ensure you get the best experience and our full <a href="/aboutus/legal/">Cookie Policy</a> is available for you. Do you accept our policy?</p>',
                    buttons: [
                        {
                            color: 'rgb(23, 173, 20)',
                            text: 'Yes',
    ...
    mounted() {
        ...
        if (this.$route.path === '/aboutus/legal') {
            this.warnings[1].hide = false
        }
    },
    methods: {
